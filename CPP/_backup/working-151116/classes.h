...
struct dof_prototype {
    ...
    int length;             //number of wabefucntion components: length=2^Ndof
                            //length=maximal value of the consecutive index
    //!for graphene sigma dof is special and has to be the first!!!
    enum name {spin,sigma,tau,eta,kappa,Ndof_max};	//generic
